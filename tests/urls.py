...
urlpatterns = [
    ...
    path('delete_test/<int:test_id>', views.DeleteTestView.as_view(), name='delete_test'),
    ...
    path('<int:answer_id>/delete_answer/', views.DeleteAnswerView.as_view(), name='delete_answer'),
    path('<int:question_id>/add_matching_pair/', views.AddMathicngPairView.as_view(), name='add_matching_pair'),
    path('<int:pair_id>/delete_matching_pair/', views.DeleteMatchingPairView.as_view(), name='delete_matching_pair'),

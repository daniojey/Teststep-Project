...
class ImageValidatorTest(TestCase):
    ...
    def test_valid_image(self):
        ...
        image = self.create_image(size=(200, 200), format='JPEG', file_size=1024)
        try:
            # Запускаем валидатор
    ...
    #     image = self.create_image(size=(2000, 2000), format='JPEG', file_size=50 * 1024 * 1024)  # 10 MB
